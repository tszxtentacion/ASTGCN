...
def search_data(sequence_length, num_of_batches, label_start_idx, num_for_predict, units, points_per_hour):
    """
    Parameters
    ----------
    ...
    # 返回的是start_idx和label_end_idx的对list
    x_idx = []
...
def get_sample_indices(data_sequence, num_of_weeks, num_of_days, num_of_hours,
    ...
    hour_indices = search_data(data_sequence.shape[0], num_of_hours,
                               label_start_idx, num_for_predict, 1, points_per_hour)
    if not week_indices:
        return None
